...
class enerzee_Client extends Widget_Base
{
	...
	{
		return __('Client', 'enerzee-extensions');
	}
	...
	protected function register_controls()
	{
		$this->start_controls_section(
			'section_client',
			[
				'label' => __('Client Post', 'enerzee-extensions'),
		...
		$this->add_control(
			'client_style',
			[
				'label'      => __('Client Style', 'enerzee-extensions'),
				'type'       => Controls_Manager::SELECT,
				'default'    => '1',
				'options'    => [

					'1'          => __('Client Slider', 'enerzee-extensions'),
					'2'          => __('Client 1 Columns', 'enerzee-extensions'),
					'3'          => __('Client 2 Columns', 'enerzee-extensions'),
					'4'          => __('Client 3 Columns', 'enerzee-extensions'),
				],
			]
		);
	...
	protected function render()
	{
		...
		require  enerzee_TH_ROOT . '/inc/elementor/render/client.php';
...
Plugin::instance()->widgets_manager->register_widget_type(new \Elementor\enerzee_Client());
