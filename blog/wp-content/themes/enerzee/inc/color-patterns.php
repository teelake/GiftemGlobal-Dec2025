 ...
 */
function enerzee_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter enerzee default saturation level.
	 *
	 * @since enerzee 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'enerzee_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.enerzee-front-page) .entry-title,
...
.colors-custom .enerzee-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.enerzee-front-page .panel-content .recent-posts article,
...
.colors-custom.enerzee-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters enerzee custom colors CSS.
	 *
	 * @since enerzee 1.0
	 *
	 ...
	 */
	return apply_filters( 'enerzee_custom_colors_css', $css, $hue, $saturation );
}
?>