...
$blog_rich_blog_container = get_theme_mod('blog_rich_blog_container', 'container-fluid');
		...
		<div class="<?php echo esc_attr($blog_rich_blog_column); ?>">
			<main id="primary" class="site-main">
				...
				while (have_posts()) :
					...
					the_post_navigation(
						array(
							'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous:', 'blog-rich') . '</span> <span class="nav-title">%title</span>',
							'next_text' => '<span class="nav-subtitle">' . esc_html__('Next:', 'blog-rich') . '</span> <span class="nav-title">%title</span>',
						)
					);
