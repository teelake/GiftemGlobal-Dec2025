...
if (!defined('BLOG_EYE_VERSION')) {
	define('BLOG_EYE_VERSION', $blog_rich_theme->get('Version'));
}
...
function blog_rich_scripts()
{
	...
	wp_enqueue_style('blog-rich-block-style', get_template_directory_uri() . '/assets/css/block.css', array(), BLOG_EYE_VERSION);
	wp_enqueue_style('blog-rich-default-style', get_template_directory_uri() . '/assets/css/default-style.css', array(), BLOG_EYE_VERSION);
	wp_enqueue_style('blog-rich-main-style', get_template_directory_uri() . '/assets/css/main.css', array(), BLOG_EYE_VERSION);
	wp_enqueue_style('blog-rich-style', get_stylesheet_uri(), array(), BLOG_EYE_VERSION);
	wp_enqueue_style('blog-rich-responsive-style', get_template_directory_uri() . '/assets/css/responsive.css', array(), BLOG_EYE_VERSION);

	wp_enqueue_script('masonry');
	wp_enqueue_script('blog-rich-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), BLOG_EYE_VERSION, true);
	wp_enqueue_script('blog-rich-mmenu-scripts', get_template_directory_uri() . '/assets/js/mobile-menu.js', array('jquery'), '1.0.0', true);
	wp_enqueue_script('blog-rich-scripts', get_template_directory_uri() . '/assets/js/scripts.js', array('jquery'), BLOG_EYE_VERSION, true);
