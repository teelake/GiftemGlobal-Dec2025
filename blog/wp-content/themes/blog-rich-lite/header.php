...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		...
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'blog-rich-lite'); ?></a>
		<?php do_action('blog_rich_mobile_menu'); ?>
		<?php $blog_rich_header_style = get_theme_mod('blog_rich_header_style', 'style1'); ?>
