        ...
        <div class="ltn__blog-item ltn__blog-item-3">
            ...
            <div class="ltn__blog-brief">
                <div class="ltn__blog-meta">
                    <ul>
                        <li class="ltn__blog-author">
                            <a href="#"><i class="far fa-user"></i>by: <?php the_author(); ?></a>
                        </li>
                        <li class="ltn__blog-tags">
                            <a href="#"><i class="fas fa-tags"></i><?php the_category(', '); ?></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="ltn__blog-meta-btn">
                    <div class="ltn__blog-meta">
                        <ul>
                            <li class="ltn__blog-date"><i class="far fa-calendar-alt"></i><?php the_date(); ?></li>
                        </ul>
                    </div>
