            ...
            <div class="ltn__gallery-active row ltn__gallery-style-1">
                ...
                <div class="ltn__gallery-item filter_category_3 col-md-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        ...
                        <a href="giftem_sunset_estate.php">
                                <img src="img/gallery/<?php echo $propertyInfo['photo1'];?> " alt="Image">
                               </a>
                        </div>
                        <div class="ltn__gallery-item-info">
                            <h4><a href="giftem_sunset_estate.php"><?php echo $propertyInfo['property1'];?> </a></h4>
                ...
                <div class="ltn__gallery-item filter_category_2 col-md-4 col-sm-6 col-12">
                    <div class="ltn__gallery-item-inner">
                        <div class="ltn__gallery-item-img">
                        <a href="giftem_diamond_court_estate.php">
                                <img src="img/gallery/<?php echo $propertyInfo['photo2'];?>" alt="Image">
                               
                           </a>
                        </div>
                        <div class="ltn__gallery-item-info">
                            <h4><a href="giftem_diamond_court_estate.php"><?php echo $propertyInfo['property2'];?>  </a></h4>
